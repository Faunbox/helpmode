                ...
                >
                  ...
                  <Modal.Body>
                    <Text id="modal-description" css={{ color: "White" }}>
                      ...
                      cookies. Pliki cookies (tzw. „ciasteczka”) stanowią dane
                      ...
                      na urządzeniu końcowym oraz unikalny numer. Podmiotem
                      zamieszczającym na urządzeniu końcowym Użytkownika Serwisu
                      pliki cookies oraz uzyskującym do nich dostęp jest
                      operator Serwisu z siedzibą pod adresem ks. Stojałowskiego
                      30, 34-326 Pietrzykowice.
                    </Text>
                    <Spacer y={1} />
                    ...
                    <Text css={{ color: "White" }}>
                      ...
                      internetowych, co umożliwia ulepszanie ich struktury i
                      zawartości;
                    </Text>
                    <Spacer y={1} />
                    <Text css={{ color: "White" }}>
                      ...
                      przez Użytkownika. W ramach Serwisu stosowane są
                    ...
                    <Text css={{ color: "white" }}>
                      ...
                      Serwisu. Szczegółowe informacje o możliwości i sposobach
                      obsługi plików cookies dostępne są w ustawieniach
                      oprogramowania (przeglądarki internetowej). Operator
                      Serwisu informuje, że ograniczenia stosowania plików
                      cookies mogą wpłynąć na niektóre funkcjonalności dostępne
                      na stronach internetowych Serwisu. Pliki cookies
                      zamieszczane w urządzeniu końcowym Użytkownika Serwisu i
                      wykorzystywane mogą być również przez współpracujących z
                      operatorem Serwisu reklamodawców oraz partnerów. Więcej
                      informacji na temat plików cookies dostępnych jest pod{" "}
                      <a
