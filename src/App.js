  ...
  return (
    <>
      ...
      >
        ...
        <Button light color="white" onClick={() => setVisible(true)}>
          ...
          >
            ...
            <Modal.Body>
              <Text id="modal-description" css={{ color: "White" }}>
                ...
                urządzeniu końcowym oraz unikalny numer. Podmiotem
                zamieszczającym na urządzeniu końcowym Użytkownika Serwisu pliki
                cookies oraz uzyskującym do nich dostęp jest operator Serwisu z
                siedzibą pod adresem ks. Stojałowskiego 30, 34-326
                Pietrzykowice.
              </Text>
              <Spacer y={1} />
              ...
              <Text css={{ color: "White" }}>
                ...
                usunięcia przez Użytkownika. W ramach Serwisu stosowane są
              ...
              <Text css={{ color: "white" }}>
                ...
                informuje, że ograniczenia stosowania plików cookies mogą
                wpłynąć na niektóre funkcjonalności dostępne na stronach
                internetowych Serwisu. Pliki cookies zamieszczane w urządzeniu
                końcowym Użytkownika Serwisu i wykorzystywane mogą być również
                przez współpracujących z operatorem Serwisu reklamodawców oraz
                partnerów. Więcej informacji na temat plików cookies dostępnych
                jest pod{" "}
                <a
